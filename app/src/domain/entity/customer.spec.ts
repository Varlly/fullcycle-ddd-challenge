import SendMessageOneWhenCustomerIsCreatedHandler from "../event/customer/handler/send-message-one-when-customer-is-created.handler.js";
import SendMessageTwoWhenCustomerIsCreatedHandler from "../event/customer/handler/send-message-two-when-customer-is-created.handler.js";
import SendMessageWhenCustomerChangedNameHandler from "../event/customer/handler/send-message-when-customer-changed-name.handler.js";
